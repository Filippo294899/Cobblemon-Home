...
class MysqlDatabaseManager : DatabaseManager() {
    ...
    override fun depositPokemon(uuid: String, boxNumber: Int?, slot: Int?, pokemon: Pokemon): Boolean {
        return try {
            if (!playerExists(uuid)) {
                addPlayer(uuid)
            }
    ...
    override fun movePokemon(uuid: String, fromBox: Int, fromSlot: Int, toBox: Int, toSlot: Int): Boolean {
        return try {
